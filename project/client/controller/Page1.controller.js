sap.ui.define([
	...
	return BaseController.extend("victoria.controller.Page1", {
		handleRouteMatched: function(oEvent) {
			...
			if (this.getView().getModel("local").getProperty("/Role") !== "Admin") {
				this.getView().byId("idPage1Admin").setVisible(false);
			}
		...
		_onStandardListItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Page2", oBindingContext, fnResolve, "", 1);
		...
		_onStandardListItemPress1: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("Admin", oBindingContext, fnResolve, "", 1);
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
